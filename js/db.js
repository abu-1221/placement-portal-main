...
class PlaceMeDB {
    constructor() {
        this.USER_KEY = 'placeme_users';
        this.TEST_KEY = 'placeme_tests';
    }
    ...
    _get(key, defaultValue) {
        try {
            ...
            console.error(`[PlaceMeDB] Read Error on ${key}:`, e);
    ...
    _save(key, data) {
        try {
            ...
            console.error(`[PlaceMeDB] Write Error on ${key}:`, e);
    ...
    getUsers() {
        ...
        if (Array.isArray(data)) {
            console.warn('[PlaceMeDB] Migrating legacy user data...');
    ...
    userExists(username) {
        ...
        return data.students.some(u => u.username === username) || 
    ...
    factoryReset() {
        ...
        console.log('[PlaceMeDB] System Reset Complete.');
        return true;
    }
}
...
(function() {
    ...
    const storedVersion = localStorage.getItem('placeme_version');
    ...
    if (storedVersion !== CURRENT_VERSION) {
        ...
        localStorage.setItem('placeme_version', CURRENT_VERSION);
        
        console.log('[PlaceMeDB] 🔄 All previous data cleared - Fresh Start!');
        console.log('[PlaceMeDB] ✅ Portal is now brand new with no historical data.');
    }
})();
...
(function() {
    window.addEventListener('load', () => {
        ...
        console.log('[PlaceMeDB] 🪄 Inputs cleared for privacy.');
    });
})();

// Export global instance
window.DB = new PlaceMeDB();
